...
namespace Senai.LanHouse.Web.Razor.Controllers
{
    public class RegistrosDefeitosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var lanHouseContext = _context.RegistrosDefeitos.Include(r => r.TiposDefeitos).Include(r => r.TiposEquipamentos);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var registrosDefeitos = await _context.RegistrosDefeitos
                .Include(r => r.TiposDefeitos)
                .Include(r => r.TiposEquipamentos)
        ...
        {
            ViewData["TiposDefeitosId"] = new SelectList(_context.TiposDefeitos, "Id", "Nome");
            ViewData["TiposEquipamentosId"] = new SelectList(_context.TiposEquipamentos, "Id", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DataDefeito,TiposEquipamentosId,TiposDefeitosId,Observação")] RegistrosDefeitos registrosDefeitos)
        {
            ...
            ViewData["TiposDefeitosId"] = new SelectList(_context.TiposDefeitos, "Id", "Nome", registrosDefeitos.TiposDefeitosId);
            ViewData["TiposEquipamentosId"] = new SelectList(_context.TiposEquipamentos, "Id", "Nome", registrosDefeitos.TiposEquipamentosId);
            return View(registrosDefeitos);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataDefeito,TiposEquipamentosId,TiposDefeitosId,Observação")] RegistrosDefeitos registrosDefeitos)
        {
